...
const ManageMyStock = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-full py-10 bg-gray-50/50">
            <div className="bg-white p-12 rounded-2xl shadow-sm border border-gray-100 w-full max-w-lg text-center">

                <div className="mb-10">
                    <h1 className="text-3xl font-bold text-gray-800 mb-2">Update Inventory</h1>
                    <p className="text-gray-400 font-medium">{stock.name || user.username} Hospital</p>
                </div>
                ...
                {success && (
                    <div className="mb-8 p-4 bg-emerald-50 border border-emerald-100 text-emerald-700 rounded-xl text-sm font-bold">
                        {success}
                    </div>
                )}
                ...
                <form onSubmit={handleSave} className="space-y-6">
                    ...
                    <div className="pt-8 space-y-4">
                        <button
                            type="submit"
                            disabled={updating}
                            className="w-full py-4 bg-red-600 text-white rounded-xl font-bold text-lg shadow-lg hover:bg-red-700 transition-all flex items-center justify-center"
                        >
                        ...
                        <button
                            ...
                            className="w-full text-gray-400 font-bold hover:text-gray-600 transition-colors py-2 text-sm"
                        >
                            Cancel
                        </button>
                    </div>
